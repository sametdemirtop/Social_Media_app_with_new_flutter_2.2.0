...
class _yuklemeSayfasiState extends State<yuklemeSayfasi> {
  ...
  Future<String> fotografYukleme(File dosya) async {
    UploadTask uploadTask = FirebaseStorage.instance.ref().child("Gonderi Fotoğrafları").child("post_$gonderiID.jpg").putFile(dosya);
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              "Paylaş",
              style: TextStyle(fontSize: 16.0, color: Colors.teal, fontWeight: FontWeight.bold),
            ),
          ),
        ],
      ),
